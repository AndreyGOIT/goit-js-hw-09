...
function onSubmitForm(amount1) {
    for(let i = 1; i <= amount1; i += 1){
        let position = i;
...
function createPromise(position, delay1) {
    ...
    if (shouldResolve) (0, _notiflixDefault.default).Notify.success(`✅ Fulfilled promise ${position} in ${delay1}ms`);
    else (0, _notiflixDefault.default).Notify.failure(`❌ Rejected promise ${position} in ${delay1}ms`);
